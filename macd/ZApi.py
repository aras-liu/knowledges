...
TPL_MARKETS = 'http://api.zb.live/data/v1/markets'
TPL_ALL_MARKET = 'http://api.zb.live/data/v1/allTicker'
TPL_MARKET = 'http://api.zb.live/data/v1/ticker?market={MARKET}'
TPL_DEPTH = 'http://api.zb.live/data/v1/depth?market={MARKET}&size={SIZE}'
TPL_TRADES = 'http://api.zb.live/data/v1/trades?market={MARKET}'
TPL_KLINE = 'http://api.zb.live/data/v1/kline?market={MARKET}&type={TYPE}'
URL_ORDER = 'https://trade.zb.live/api/order'
URL_CANCEL_ORDER = 'https://trade.zb.live/api/cancelOrder'
URL_GET_ORDER = 'https://trade.zb.live/api/getOrder'
URL_GET_ORDERS = 'https://trade.zb.live/api/getOrders'
URL_GET_ORDERS_NEW = 'https://trade.zb.live/api/getOrdersNew'
URL_GET_ORDERS_IGNORE_TRADE_TYPE = 'https://trade.zb.live/api/getOrdersIgnoreTradeType'
URL_GET_UNFINISHED_ORDERS_IGNORE_TRADE_TYPE = 'https://trade.zb.live/api/getUnfinishedOrdersIgnoreTradeType'
URL_GET_ACCOUNT_INFO = 'https://trade.zb.live/api/getAccountInfo'
URL_GET_USER_ADDRESS = 'https://trade.zb.live/api/getUserAddress'
URL_GET_WITHDRAW_ADDRESS = 'https://trade.zb.live/api/getWithdrawAddress'
URL_GET_WITHDRAW_RECORD = 'https://trade.zb.live/api/getWithdrawRecord'
URL_GET_CHARGE_RECORD = 'https://trade.zb.live/api/getChargeRecord'
URL_WITHDRAW = 'https://trade.zb.live/api/withdraw'
URL_doTransferFunds = 'https://trade.zb.live/api/doTransferFunds'
...
class ZApi:
    ...
    def kline(self, market,type):
        ...
        :return: kline data
        """
        url = TPL_KLINE.format(MARKET=market,TYPE=type)
        # print(url)
        return self.get(url)
    ...
    def get_orders(self, market, page, tradeType ):
        """
        ...
        :param type: order type [1:buy;0:sell]
        :return: result
        """
        params = 'accesskey=%s&currency=%s&method=getOrders&pageIndex=%s&tradeType=%s' % (
            self._access_key_, market, page, tradeType )
    ...
    def zhuanzhang_zi(self, amount, currency, fromUerName, toUserName):
        ...
        return self.call_api(url='https://trade.zb.live/api/doTransferFunds', params=params)
    ...
    def huoquzizhanghao(self):
        ...
        return self.call_api(url='https://trade.zb.live/api/getSubUserList', params=params)
    ...
    def chuangjianzi(self):
        ...
        return self.call_api(url='https://trade.zb.live/api/addSubUser', params=params)
    ...
    def call_api(self, url, params=''):
        ...
        while True:
            try:
                ...
                r = requests.get(full_url, headers=h, timeout=2)
            except Exception:
                time.sleep(0.5)
                continue
            if r.status_code != 200:
...
def main():
    ...
    zapi = ZApi(acc, sec)
    # res = zapi.get_account_info()
    res = zapi.ticker("btc_qc")
    print(res)
    res = zapi.get_orders("btc_qc", 1, 1)
    print(res)
